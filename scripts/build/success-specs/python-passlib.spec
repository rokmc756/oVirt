...
%package -n python39-passlib
Summary:        Comprehensive password hashing framework supporting over 20 schemes
BuildRequires:  python39-devel
BuildRequires:	python39-setuptools

%description -n python39-passlib
Passlib is a password hashing library for Python 2 & 3, which provides
cross-platform implementations of over 20 password hashing algorithms,
as well as a framework for managing existing password hashes. It's
designed to be useful for a wide range of tasks, from verifying a hash
...
%package -n python3.11-passlib
Summary:        Comprehensive password hashing framework supporting over 20 schemes
BuildRequires:  python3.11-devel
BuildRequires:	python3.11-setuptools

%description -n python3.11-passlib
Passlib is a password hashing library for Python 2 & 3, which provides
cross-platform implementations of over 20 password hashing algorithms,
as well as a framework for managing existing password hashes. It's
designed to be useful for a wide range of tasks, from verifying a hash
...
%changelog
* Wed Mar 01 2023 Martin Necas <mnecas@redhat.com> - 1.7.4-3.1
