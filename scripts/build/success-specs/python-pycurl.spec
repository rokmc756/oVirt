...
%package -n python39-%{modname}
Summary:        Python interface to libcurl for Python 3.9
BuildRequires:  python39-devel
BuildRequires:  python39-setuptools
%{?python_provide:%python_provide python39-%{modname}}
Requires:       libcurl%{?_isa} >= %{libcurl_ver}

%description -n python39-%{modname}
PycURL is a Python interface to libcurl. PycURL can be used to fetch
objects identified by a URL from a Python program, similar to the
urllib Python module. PycURL is mature, very fast, and supports a lot
of features.
...
%package -n python3.11-%{modname}
Summary:        Python interface to libcurl for Python 3.11
BuildRequires:  python3.11-devel
BuildRequires:  python3.11-setuptools
%{?python_provide:%python_provide python3.11-%{modname}}
Requires:       libcurl%{?_isa} >= %{libcurl_ver}

%description -n python3.11-%{modname}
PycURL is a Python interface to libcurl. PycURL can be used to fetch
objects identified by a URL from a Python program, similar to the
urllib Python module. PycURL is mature, very fast, and supports a lot
of features.
...
%changelog
* Wed Mar 01 2023 Martin Necas <mnecas@redhat.com> - 7.45.2-2.1
