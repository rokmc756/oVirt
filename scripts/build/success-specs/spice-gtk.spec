...
# Patches are numbered according to their order in the upstream git repo
# Created using git format-patch v0.39
Patch0005:      0005-gstaudio-remove-record-bus-watch-to-release-GstBus.patch
Patch0007:      0007-Add-some-ABI-size-checks-for-what-we-are-modifying-n.patch
Patch0008:      0008-Fix-g-i-class-size-binding.patch
Patch0017:      0017-Fix-potential-div0-crash.patch
...
# Keep builtin-mjpeg for now
%global mjpegflag -Dbuiltin-mjpeg=true
# The celt051 option is removed in v0.39, appears here for clarity
%global celt051flag -Dcelt051=disabled
# The pulse   option is removed in v0.39, appears here for clarity
...
%changelog
* Tue Dec 14 2021 Sandro Bonazzola <sbonazzo@redhat.com> - 0.39-6.el9
- Rebuilt for CentOS Virt SIG
- Source: http://ftp.redhat.com/pub/redhat/linux/enterprise/9Base/en/RHEV/SRPMS/spice-gtk-0.39-5.el9ev.src.rpm

* Mon Aug 16 2021 Uri Lublin <uril@redhat.com> - 0.39-5.el9ev
- Rebuilt following glibc 2.34 rebase
  Related: rhbz#1991688

* Wed Jun 30 2021 Uri Lublin <uril@redhat.com> - 0.39-4.el9ev
- Rebuilt for RHV
